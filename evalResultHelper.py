...
def get_predicted(predicted, answers=defaultdict(lambda: defaultdict(defaultdict)), separator=' ',outputColumnIndex=1):
...
def get_observed(observed, separator=' ', outputColumnIndex=1):
...
def compare_observed_to_predicted(observed, predicted, discardInstance=[]):
